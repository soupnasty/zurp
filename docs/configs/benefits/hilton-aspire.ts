...
const freeNightDetails: BenefitDetails = {
  description:
    "Annual free night certificate with no category limits (up to 200,000 Hilton Honors points value) valid at any Hilton property worldwide. Certificates do not expire during the year of issuance.",
  howToUse: [
    "Log in to hiltonhonors.com",
    "Go to My Benefits → Free Night Certificate",
    "Search for a Hilton property within your certificate's point value",
    "Redeem the certificate for a free night",
    "New certificate issued each cardmember anniversary",
  ],
  links: [
    { label: "Hilton Honors", url: "https://www.hiltonhonors.com" },
    {
      label: "Learn More",
...
export const hiltonAspire: CardDefinition = {
  ...
  benefits: [
    ...
    b({
      ...
      priority: 30,
      description:
        "Annual free night certificate at any Hilton property (up to 200,000 points value).",
      notes:
        "No category limits. Valid worldwide. Expires end of following year.",
