...
- **Perk matrix** (`perk-matrix.ts`): Static benefit comparison data for the Benefits & Perks tab (6 cards).
...
6 cards: CSR, CSP, Amex Gold, Amex Platinum, Citi Strata Elite, Capital One Venture X.
