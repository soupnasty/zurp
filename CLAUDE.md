...
Every `CardDefinition` carries `lastVerifiedAt` (ISO date its benefits/fees/rates were last checked against issuer terms — all 30 stamped 2026-08-13; see `docs/audits/zurp-card-audit-2026-08.md`). Update it whenever a card's config is re-verified. Discontinued benefits are never deleted (usage history references their IDs): set a past `sunsetDate` and mark the copy DISCONTINUED — `BenefitDefinition` has no `isActive` field.

30 cards: CSR, CSP, CFF, CFU, Amex Gold, Amex Blue Cash Preferred, Amex Platinum, Citi Strata Elite, Citi Strata Premier, Capital One Venture X, Capital One Venture, Robinhood Gold, Bilt Palladium, Amex Blue Cash Everyday, Citi Custom Cash, Citi Double Cash, Discover it Cash Back, US Bank Altitude Connect, Wells Fargo Active Cash, Wells Fargo Autograph Journey, Amex Business Platinum, Apple Card, Capital One SavorOne, Delta SkyMiles Platinum, Hilton Honors Aspire, IHG One Rewards Premier, Chase Ink Business Preferred, Southwest Rapid Rewards Priority, United Explorer, World of Hyatt.

The Chase Freedom Flex (`chase-freedom-flex.ts`) has 5 benefits (6-month DashPass trial + 4 quarterly $10 DoorDash non-restaurant credits, all through 12/31/2027). $0 annual fee, Mastercard network. 1x base rate with 5% rotating quarterly categories (not modeled — changes each quarter), 3x dining/drugstores, 5x Chase Travel portal. Earns Chase UR points poolable with CSR/CSP. Points valued at 1.0-2.0cpp (via CSR/CSP transfer partners). Cell phone protection ends 9/20/2026; card drops its 3% FTF the same day.

The Chase Freedom Unlimited (`chase-freedom-unlimited.ts`) has 5 benefits (6-month DashPass trial + 4 quarterly $10 DoorDash non-restaurant credits, all through 12/31/2027). $0 annual fee, Visa network. 1.5x flat base rate (highest non-rotating Chase rate), 3x dining/drugstores, 5x Chase Travel portal. Earns Chase UR points poolable with CSR/CSP. Points valued at 1.0-2.0cpp (via CSR/CSP transfer partners).

The Amex Blue Cash Preferred (`amex-blue-cash-preferred.ts`) has 1 benefit (Disney Streaming Credit $10/mo — individual Disney+/Hulu/ESPN subscriptions qualify). First pure cash-back card in the system — `pointsCurrency: "cash_back"` with fixed 1.0cpp valuation. 6% US supermarkets (capped $6K/yr), 6% streaming (uncapped), 3% ground transit/gas (flights/cruises/car rentals excluded — 1%), 1% base. $95/yr fee. Amex network. No transfer partners. 2.7% FTF.

The Amex Platinum (`amex-platinum.ts`) has 21 benefit records across 5 period types including quarterly (Saks x2 sunset 2026-06-30 — benefit killed 7/1/2026, retained for history; CLEAR credit now $219). It uses `activeMonths` gating for Uber Cash month-specific credits ($15 Jan-Nov, $35 Dec). 5x flights capped at $500K/cal yr.

The Citi Strata Elite (`citi-strata-elite.ts`) has 2 benefits ($300 hotel credit via Citi Travel portal, Global Entry/TSA PreCheck). Its primary value is in earning rates via the points engine, not statement credits. Citi Nights 6x dining runs Fri–Sat 6PM–6AM ET (overnight window — the calculator's `matchesTimeWindow` supports endHour ≤ startHour wrapping to the next day).
...
The Capital One Venture (`capital-one-venture.ts`) has 3 benefit records but only 2 live ($120 Global Entry/TSA PreCheck every 4 years, No FTF; the "$250 annual travel credit" was actually a one-time first-year welcome-offer component and is sunset 2026-04-30, retained for usage history). Mid-tier sibling to Venture X — flat 2x base rate, 5x portal hotels/rentals (NOT flights — those stay 2x). $95/yr fee, Visa network. Same Capital One miles pool. Points valued at 1.0-1.5cpp. Issuer is "capital_one" (same as Venture X).

The Robinhood Gold (`robinhood-gold.ts`) has 1 benefit record (No FTF — sunset 2026-06-30: accounts opened on/after 7/1/2026 pay 3% FTF; earlier accounts grandfathered). Its value is entirely in its 3x flat earning rate (highest base rate of any card). 5x on Robinhood Travel portal with $3,500/yr cap (verified against Robinhood's own terms). $50/yr fee (Robinhood Gold membership). Points valued at 1.0cpp fixed only via brokerage redemption (statement credits pay 0.7cpp). No transfer partners, no lounges, no statement credits, no cell phone protection.

The Bilt Palladium (`bilt-palladium.ts`) has 4 benefit records from 3 logical benefits: $400/yr hotel credit via Bilt Travel portal ($200 semi-annual via expandCycles), $200/yr Bilt Cash annual credit, and No FTF. 2x base earning plus bonus categories: up to 5x Bilt Dining, 4x Bilt Travel hotels, 3x Bilt Travel flights, 4x Lyft (rent/mortgage 1.25x not modeled — no rent category in the taxonomy). 24-25 transfer partners (Wyndham 1:1, I Prefer 1:2, Accor 3:2) with Rent Day 75% bonus. Points valued at 1.5-2.2cpp. $495/yr fee. Issuer is "bilt" for Plaid detection.

The Amex Blue Cash Everyday (`amex-blue-cash-everyday.ts`) has 2 benefits (Disney Streaming Credit $7/mo — individual services qualify; Home Chef $15/mo). $0 annual fee, Amex network. 3% US supermarkets (capped $6K/yr), 3% gas (capped $6K/yr), 3% online retail (capped $6K/yr), 1% base. Cash back currency at fixed 1.0cpp valuation. 2.7% FTF.
...
The US Bank Altitude Connect (`us-bank-altitude-connect.ts`) has 2 benefits (Global Entry/TSA PreCheck $100/4yr, GigSky global eSIM data through 11/30/2026). $0 annual fee, Visa network. 5x US Bank Rewards Center, 4x travel/gas ($4K/yr gas cap), 2x dining/groceries/streaming, 1x base. Priority Pass (4 visits/yr) tracked in perk matrix only.
...
The Wells Fargo Autograph Journey (`wells-fargo-autograph-journey.ts`) has 1 benefit (Airline Credit $50/anniversary-year, any airline charge $50+, cycle annual_anniversary). $95 annual fee, Visa network. 5x hotels, 4x airlines, 3x restaurants and other travel (incl. rental cars), 1x everything else (no gas/streaming/phone bonus). 8 airline transfer partners at 1:1 (Flying Blue, Avianca, BA, Iberia, Virgin Atlantic, Aer Lingus, JetBlue, Cathay Pacific) + Choice 1:2 and Wyndham. No FTF.
...
The Apple Card (`apple-card.ts`) has 0 benefits (Daily Cash is earning structure, not a trackable credit). $0 annual fee, Mastercard network. Issuer is "goldman_sachs" (Chase acquisition announced Jan 2026, ~24-month migration; Goldman still services accounts). 3% at select merchants (Apple, Uber, Nike, Exxon/Mobil, Walgreens, Ace Hardware, Booking.com, ChargePoint, Hertz) via merchant_match conditions, 1% base (2% Apple Pay). Cash back currency at fixed 1.0cpp. No FTF.

The Capital One Savor (`capital-one-savor.ts`, renamed from SavorOne in Oct 2024; card id stays `capital_one_savor`) has 0 benefits. $0 annual fee, Mastercard network. 8x Capital One Entertainment portal, 5x travel portal hotels/vacation rentals, 3x dining/entertainment/streaming/groceries, 1% base. Cash back currency at fixed 1.0cpp. No FTF. Note: Capital One reused the "SavorOne" name for a different fair-credit card with an annual fee — detection collision documented in detect.ts.

The Delta SkyMiles Platinum (`delta-platinum.ts`) has 5 benefit records, 3 live ($150/yr Delta Stays credit, $120/yr Resy credit $10/mo, $120/yr rideshare credit $10/mo) and 2 sunset for history (the "$200 flight credit" was actually a Delta Gold benefit, never Platinum; Uber One enrollment closed 6/25/2026). Companion Certificate tracked in perk matrix only. $350 annual fee, Amex network. 3x Delta flights (merchant_match), 3x hotels, 2x dining/groceries, 1x base. Delta SkyMiles valued at 1.0-1.4cpp. No Sky Club access (eliminated Jan 2024).

The Hilton Honors Aspire (`hilton-aspire.ts`) has 7 benefits ($200 resort credit x2 semi-annual at participating Hilton Resorts, $50 flight credit x4 quarterly — airfare eligible, not incidentals-only, $219 CLEAR Plus). Free Night Certificate tracked in perk matrix only. $550 annual fee, Amex network. 14x Hilton (merchant_match, 13 brands), 7x flights/dining/cars, 3x base. Hilton points valued at 0.5-0.8cpp. Has cell phone protection ($800/claim).

The IHG One Rewards Premier (`ihg-premier.ts`) has 2 benefits (Global Entry $120/quadrennial, $50/yr United TravelBank cash requiring MileagePlus registration). Free Night Certificate tracked in perk matrix only. $99 annual fee, Visa network. 10x IHG (merchant_match, 13 brands), 5x flights/cars/dining/gas, 3x base. IHG points valued at 0.5-0.8cpp.

The Chase Ink Business Preferred (`ink-business-preferred.ts`) has 2 benefits (complimentary DashPass, $10/mo DoorDash non-restaurant credit, both through 12/31/2027). $95 annual fee, Visa network. 5x Lyft (merchant_match, through 9/30/2027), 3x travel/phone_services ($150K/yr combined cap), 1x base. Chase UR points valued at 1.0-2.0cpp (via transfer partners). Cell phone protection $1,000/claim, 3 claims/yr.

The Southwest Rapid Rewards Priority (`southwest-priority.ts`) has 1 benefit record, sunset for history (the $75/yr travel credit was discontinued in the July 2025 refresh, dead 12/31/2025). Extra Legroom upgrades + Group 5 boarding (replaced Upgraded Boardings Jan 2026) tracked in perk matrix only. $229 annual fee, Visa network. 4x Southwest flights (merchant_match), 2x dining, 2x gas, 1x base. Rapid Rewards points valued at 1.2-1.4cpp (post-2025 devaluations).

The United Explorer (`united-explorer.ts`) has 4 benefits ($100/yr United TravelBank cash gated on $10K calendar-year spend — not auto-matchable, $5/mo rideshare credit requiring annual enrollment, $10/mo Instacart credit through 12/31/2027, $120 Global Entry quadrennial). United Club passes tracked in perk matrix only. $150 annual fee, Visa network. 3x United flights (merchant_match; the 9x headline includes non-card member miles), 2x dining/hotels, 1x base. MileagePlus miles valued at 1.0-1.5cpp.
