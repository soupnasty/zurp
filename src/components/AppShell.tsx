...
export function AppShell({ children, userEmail }: AppShellProps) {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-40 flex h-screen flex-col border-r border-[var(--border-default)] bg-[var(--bg-secondary)] transition-all duration-[var(--duration-default)] ease-[var(--ease-default)] ${
          collapsed ? "w-16" : "w-56"
        }`}
      >
        {/* Logo */}
      ...
      {/* Main content */}
      <main
        className={`flex-1 transition-all duration-[var(--duration-default)] ease-[var(--ease-default)] ${
