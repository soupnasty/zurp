...
const CFF_ROTATING_QUARTERS: RotatingQuarterEntry[] = [
  ...
  // ── 2025 ──
  {
    ...
    endDate: "2025-03-31",
    categories: ["groceries", "grocery_online", "fitness"],
    label: "Grocery stores, fitness clubs & gym memberships",
  },
  {
    quarter: "2025_Q2",
    startDate: "2025-04-01",
    endDate: "2025-06-30",
    categories: ["gas_stations", "home_improvement", "streaming"],
    label: "Gas stations, home improvement stores, select streaming",
  },
  {
    quarter: "2025_Q3",
