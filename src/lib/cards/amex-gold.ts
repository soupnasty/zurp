...
export const amexGold: CardDefinition = {
  ...
  benefits: [
    // ── Monthly Dining Credit ($10/mo) ──
    {
      ...
      priority: 20,
      description:
        "Up to $10/month in statement credits at Grubhub, The Cheesecake Factory, Goldbelly, Wine.com, and Five Guys.",
      notes:
        "Must enroll before first purchase. Shared across primary + authorized users ($10 total). Gift cards do not qualify.",
      sunsetDate: null,
      sourceUrl: null,
      displayGroup: null,
    ...
    // ── Resy Dining Credit H1 ($50, Jan-Jun) ──
    {
      id: "gold_resy_credit_h1",
      cardId: "amex_gold",
      ...
      priority: 10,
      description:
        "Up to $50 in statement credits for Resy dining experiences (Jan-Jun).",
      notes:
        "Dine at Resy-affiliated restaurants or purchase on Resy.com/app. Reservation through Resy not required.",
      sunsetDate: null,
      sourceUrl: null,
      displayGroup: null,
      displayGroupName: null,
    ...
    // ── Resy Dining Credit H2 ($50, Jul-Dec) ──
    {
      id: "gold_resy_credit_h2",
      cardId: "amex_gold",
      name: "Resy Dining Credit",
      icon: "UtensilsCrossed",
      category: "dining",
      ...
      priority: 10,
      description:
        "Up to $50 in statement credits for Resy dining experiences (Jul-Dec).",
      notes:
        "Dine at Resy-affiliated restaurants or purchase on Resy.com/app. Reservation through Resy not required.",
      sunsetDate: null,
      sourceUrl: null,
    ...
    // ── Monthly Dunkin' Credit ($7/mo) ──
    {
      ...
      priority: 20,
      description:
        "Up to $7/month in statement credits at Dunkin'.",
      notes:
        "U.S. Dunkin' locations only (in-store or via Dunkin' app). Must enroll before first purchase.",
      sunsetDate: null,
      sourceUrl: null,
      displayGroup: null,
      displayGroupName: null,
